...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // Инициализируем mAuth до вызова applySavedTheme()
        mAuth = FirebaseAuth.getInstance();

        // Загружаем и применяем тему перед установкой контента
        applySavedTheme();
    ...
    private void initvar() {
        ...
        pager.setUserInputEnabled(false); // Блокируем свайпы
    }
    ...
    private void applySavedTheme() {
        ...
        // Безопасно проверяем авторизацию
        if (mAuth != null && mAuth.getCurrentUser() != null) {
            ...
            // Если пользователь не авторизован, используем сохранённую тему
            AppCompatDelegate.setDefaultNightMode(savedTheme);
        }
    }
    ...
    public void toggleTheme() {
        ...
        // Пересоздаём активность с анимацией
        recreate();
    }
