...
public class ForEditOrganizerAdapter extends RecyclerView.Adapter<ForEditOrganizerAdapter.OrganizerViewHolder> {
    private static final String TAG = "ForEditOrganizerAdapter";
    private final List<UserProfile> organizers;
    private Context context;

    public ForEditOrganizerAdapter(List<UserProfile> organizers) {
